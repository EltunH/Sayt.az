    ...
    customerData.map((item) => (
        customerContainer.innerHTML += `
                <div class="flex flex-col bg-white justify-between p-6 items-center h-[280px] w-[33%] rounded-lg shadow-[0_4px_8px_5px_rgba(0,0,0,0.1)]">
                    ...
                    <div class="rounded-[50%] text[19px] w-[75px] h-[75px] border-[5px] ${item.percent === 100 ? 'border-[#22bfa5]' : 'border-[#fc5185]'}  my-[10px] text-[19px] font-semibold flex items-center justify-center">${item.percent}%</div>
